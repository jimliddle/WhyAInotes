...
You can use the App directly from your browser and all state is stored on your loccal browser - nothing server-side: https://jimliddle.github.io/Why AIsnotes/
